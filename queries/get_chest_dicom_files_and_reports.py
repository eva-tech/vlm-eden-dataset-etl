...
"""Queries to get all DICOM files and reports from randomly selected 8 studies in pacs_studies."""

# Query following the pattern with randomly selected 8 studies from pacs_studies
# Supports pagination with OFFSET and LIMIT
get_all_studies_data = """
WITH all_studies AS (
  -- Randomly select 8 studies from pacs_studies
  SELECT id
  FROM pacs_studies
  WHERE deleted = FALSE
  ORDER BY RANDOM()
