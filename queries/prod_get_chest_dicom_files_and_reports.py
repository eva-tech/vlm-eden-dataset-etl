"""Production queries to get DICOM files and reports from CR/DX chest studies signed by doctors ranked 2-6."""

# Query following the pattern with studies from CR/DX modalities, chest body part, 
