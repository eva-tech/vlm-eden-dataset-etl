...
from queries.dim_facitities import get_all_facilities, insert_facilities, insert_facilities_template
...
class SyncFacilities(SyncBase):
    ...
    def retrieve_data(self):
        ...
        extras.execute_values(
            self.destination_cursor, sql_query, data, template=insert_facilities_template, page_size=1000
        )
